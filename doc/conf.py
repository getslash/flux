...
releases_github_path = "vmalloc/flux"
...
project = u'flux'
copyright = u'2013-2020, Rotem Yaari'  # pylint: disable=redefined-builtin
...
version = release = pkg_resources.get_distribution('flux').version
...
html_theme_options = {
    ...
    'github_banner': False,
    'extra_nav_links': {
        'Flux@Pypi': 'https://pypi.org/project/flux',
    }
}
...
texinfo_documents = [
  ('index', 'flux', u'flux Documentation',
   u'Rotem Yaari', 'flux', 'One line description of project.',
   'Miscellaneous'),
]
